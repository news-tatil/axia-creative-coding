...
function preload() {
    logo_svg.push(loadXML("assets/symbol/svg/logo_01.svg"))
    logo_svg.push(loadXML("assets/symbol/svg/logo_02.svg"))
    logo_svg.push(loadXML("assets/symbol/svg/logo_03.svg"))
    logo_svg.push(loadXML("assets/symbol/svg/logo_04.svg"))

    selo_svg.push(loadXML("assets/symbol/svg/selo_01.svg"))
    selo_svg.push(loadXML("assets/symbol/svg/selo_02.svg"))
    selo_svg.push(loadXML("assets/symbol/svg/selo_03.svg"))

    img_textura = loadImage("assets/symbol/img/img.png")
}
